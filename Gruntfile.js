module.exports =function(grunt) {
    ...
    grunt.initConfig({
        ...
        copy : {
            ...
            staticcss:{
                src: ['<%=pkg.version%>/css/pratise.css','<%=pkg.version%>/css/global.css','<%=pkg.version%>/css-debug/global.css',
                    '<%=pkg.version%>/css-debug/pratise.css','<%=pkg.version%>/img/**'],
